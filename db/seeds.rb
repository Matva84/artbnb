...
Masterpiece.new(title: "Flamenco", description: "Cette œuvre créée en terre fut moulée pour être réalisée en 8 tirages et 4 épreuves d'artiste.", price: "4500", address: "France", category: "sculture", user_id: user_mv.id)
...
Masterpiece.new(title: "Mhysa", description: "À travers mes séries photographiques intitulées Wanderlust, j'explore le thème ethnique en incarnant mentalement des femmes du monde entier.", price: "1500", address: "France", category: "photo", user_id: user_gl.id)
...
Masterpiece.new(title: "Bubbles and bonbons", description: "Née en 1971 à San Francisco, la peintre Amy Nelder appelle son œuvre « Pop Trompe L'oeil ».", price: "6580", address: "Etats-Unis", category: "paint", user_id: user_fl.id)
...
Masterpiece.new(title: "Marius", description: "Sculpture : acrylique, métal, résine", price: "1100", address: "France", category: "sculture", user_id: user_bq.id)
...
Masterpiece.new(title: "Coluche", description: "Iconic Portraits", price: "1400", address: "Belgique", category: "photo", user_id: user_mv.id)
...
Masterpiece.new(title: "Andalouse", description: "Sculpture réalisée entièrement à la main, en chêne teinté par oxydation et feuille d'or.", price: "1960", address: "France", category: "sculture", user_id: user_gl.id)
...
Masterpiece.new(title: "Boy looking up", description: "Peinture : peinture aérosol, Pochoir", price: "3900", address: "Belgique", category: "paint", user_id: user_fl.id)
...
Masterpiece.new(title: "Orbe", description: "À travers ses photographies mais aussi ses éditions, l’artiste fabrique un univers onirique et illusoire.", price: "1800", address: "France", category: "photo", user_id: user_bq.id)
...
Masterpiece.new(title: "Alfons bois", description: "Oeuvre unique, sculpture en bois, chaque tranche est découpée au laser et après assemblée à la main.", price: "1900", address: "Etats Unis", category: "sculture", user_id: user_mv.id)
